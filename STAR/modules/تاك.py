...
@Client.on_message(command(["المالك", "صاحب الخرابه", "المنشي", "المنشئ"]) & filters.group)
...
@Client.on_message(command(["اسمي", "اسمي اي"]) & filters.group )
...
array = []
@Client.on_message(command(["@all", "تاك","تاك للكل"]) & ~filters.private)
...
@Client.on_message(command(["بس المنشن", "/cancel","بس منشن"]))
