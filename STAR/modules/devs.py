...
from STAR import app, OWNER
from STAR import app
from STAR.config import OWNER_ID, BOT_NAME
from STAR.database.chats import blacklist_chat, blacklisted_chats, whitelist_chat
from STAR.utils.decorators import sudo_users_only
from STAR.utils.filters import command
from STAR.modules import check_heroku
from STAR.utils.decorators import errors
from STAR.database.functions import start_restart_stage
...
async def update(_, message: Message):
    ...
    if str(m[0]) != "A":
        ...
        os.execvp("python3", ["python3", "-m", "STAR"])
    else:
        await message.reply_text("Bot is already in the **up-to-date** mode with **[latest version](https://github.com/DaRrKNneSs1/STARMUSIC)**", disable_web_page_preview=True)
